...
function addOneTimeTask(func, delay) {
	...
	let myObject = { func: func, delay: delay };
	oneTimeTasks.push(myObject);
	return myObject;
...
function startMonitoring() {
	...
	monitoringTaskId = setInterval(() => {
		console.log('Monitoring the skys...');
	}, 3000);
}
...
function scheduleMission() {
	...
	addOneTimeTask(startMonitoring, 100);
	addOneTimeTask(stopMonitoring, 10000);
	addOneTimeTask(() => startCountdown(10), 10000);
	runOneTimeTasks();
}
